...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the town Blackmoor, my abilities are sharper due to my routine and familiarity."),
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the grove and coast of Blackmoor, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_CABAL = span_info("In secret, I have studied the ways of His ascension, and know of others of the Kabal."),
	...
	TRAIT_RESIDENT = span_info("I've been granted a Meister account, and the ownership of a house in Blackmoor."),
